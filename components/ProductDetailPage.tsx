  ...
  if (isLoading) {
    return (
      <Container className="py-10">
        <p className="text-sm text-gray-600">Product is loading...</p>
      </Container>
    );
  }
      ...
      <Container className="flex flex-col md:flex-row gap-10 py-10">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-5">
          ...
          <div className="flex items-center gap-2.5 lg:gap-3">
            <AddToCartButton product={product} className="md:w-full rounded-[10px]" />
          ...
          <div className="flex flex-col">
            <div className="border border-light-color/25 border-b-0 p-3 flex items-center gap-2.5">
            ...
            <div className="border border-light-color/25 p-3 flex items-center gap-2.5">
